...
export class LeadComponent implements OnInit {
  ...
  trackId(_index: number, item: ILead): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ILead[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
